...
export const apps: App[] = [
  ...
  },
  {
    id: 'swirlball',
    title: 'SwirlBall',
    tagline: 'Tilt, bounce, descend',
    description: 'Tilt the tower, match the colors, and guide a bouncing ball down. 60 levels, an endless tower, no ads.',
    fullDescription:
      'SwirlBall is a tilt-controlled arcade game. Rotate a pastel tower by tilting your iPhone (or with touch), and guide a constantly bouncing ball to the bottom: land on your color, slip through gaps, and avoid the striped danger sectors. Master 60 handcrafted levels across twelve chapters, then chase depth records in the procedurally generated Endless Tower. Collect Sparks for cosmetic skins, chain multi-layer combo dives, and enjoy a completely ad-free experience with no energy timers.',
    category: 'Games',
    platform: 'iOS',
    appStoreId: null,
    appStoreUrl: null,
    supportEmail: 'B.S.NikishinG@gmail.com',
    gradient: 'from-violet-400 via-purple-400 to-emerald-400',
    color: '#8a6be8',
    iconPath: '/icons/swirlball.png',
    features: [
      'Tilt controls with calibration — or full touch steering',
      '60 handcrafted levels across 12 pastel chapters',
      'Endless Tower with depth milestones and an exclusive skin',
      'Combo dives — skip layers for up to ×5 score',
      '18 cosmetic ball skins unlocked with Sparks',
      'Danger is always readable: color plus pattern, never color alone',
      'No ads, no energy, no timers — ever',
      'Optional revives and reward doubling; a pure "thanks" tip',
    ],
  },
  {
    id: 'cozyball',
